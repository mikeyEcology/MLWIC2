...
ui <- fluidPage(
  ...
  shiny::sidebarLayout(
    ...
    shiny::sidebarPanel(
      ...
      shiny::shinyFilesButton('data_info', "Image label file", title="Select file containing file names of images and their classification", multiple=FALSE),
      shiny::textOutput("data_info"),
      #textInput("model_dir", "Model Directory"),
      shiny::shinyDirButton('model_dir', 'Trained model directory', title="Select the location where you stored the 'trained_model' folder"),
